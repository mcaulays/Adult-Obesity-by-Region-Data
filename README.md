...
1. Data: which holds two files, one being the original [CountyHealthData_2014-2015.csv], and the second being the manipulated data subset, Adult Obesity by Region.
